...
/* This function add the inputed task to the get_todos function array */
function add() {
...
function show() {
    ...
    for (var i = 0; i < todos.length; i++) {
        /* This also displays the task as a list and creates the button eith the "x" */
        html += '<li>' + todos[i] + '  <button class="remove" id="' + i + '" onclick="remove(id)">x</button></li>';
